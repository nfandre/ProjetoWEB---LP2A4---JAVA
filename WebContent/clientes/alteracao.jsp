<html><head>
          ...
          <div class="col-md-12">
            <form class="form-horizontal" role="form">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="cpf" placeholder="cpf" pattern="\d{3}\.\d{3}\.\d{3}-\d{2}" title="Digite um CPF no formato: xxx.xxx.xxx-xx" required="">
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-2">
              ...
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  <button type="submit" class="btn btn-info"  id="alterar">Alterar</button>
                  <h2 id='result'></h2>
                  <h2 id="resultCpf"> </h2>
                </div>
              </div>
    ...
    <footer>
     ...
     <script type="text/javascript">
	    document.getElementById("alterar").onclick = function(e){
	    	validarCpfEmail()
	    }
    </script>
