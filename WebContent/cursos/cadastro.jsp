        ...
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" role="form" action="../CursoControlador?rota=add" method="post">
              ...
              <div class="form-group">
                <div class="col-sm-2">
                  <label for="inputNome" class="control-label">Informar a DESCRIÇÃO:</label>
                </div>
                <div class="col-sm-10">
                  <input name="descricao" type="text" class="form-control" id="inputNome" placeholder="Descrição">
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-2">
